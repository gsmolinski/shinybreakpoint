...
We will start from the snippet^[Run `?shinybreakpoint::snippet` to see the documentation for function to write the snippet to the opened (and saved) file in RStudio] - minimal skeleton needed to successfully run the Shiny app with the `shinybreakpoint` functionality:
